    ...
    <div className="min-h-[100dvh] flex flex-col bg-background text-foreground pb-20">
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-50 bg-card border-t border-border pb-safe">
        <div className="max-w-lg mx-auto px-4 h-16 flex items-center justify-between relative">
          ...
          <Link href="/transactions" className={`flex flex-col items-center justify-center w-16 h-full transition-colors ${location === '/transactions' ? 'text-primary' : 'text-muted-foreground hover:text-foreground'}`}>
            ...
            <Dialog>
              ...
              <DialogContent className="w-11/12 max-w-sm rounded-2xl">
                ...
                <div className="grid grid-cols-2 gap-4 py-4">
                  <button onClick={() => setLocation('/transactions/new?type=earn')} className="flex flex-col items-center justify-center p-6 bg-secondary/50 rounded-xl border border-transparent hover:border-primary/50 transition-colors">
                  ...
                  <button onClick={() => setLocation('/transactions/new?type=spend')} className="flex flex-col items-center justify-center p-6 bg-secondary/50 rounded-xl border border-transparent hover:border-destructive/50 transition-colors">
                  ...
                  <button onClick={() => setLocation('/transactions/new?type=lend')} className="flex flex-col items-center justify-center p-6 bg-secondary/50 rounded-xl border border-transparent hover:border-blue-500/50 transition-colors">
                  ...
                  <button onClick={() => setLocation('/transactions/new?type=borrow')} className="flex flex-col items-center justify-center p-6 bg-secondary/50 rounded-xl border border-transparent hover:border-amber-500/50 transition-colors">
          ...
          <Link href="/reports" className={`flex flex-col items-center justify-center w-16 h-full transition-colors ${location === '/reports' ? 'text-primary' : 'text-muted-foreground hover:text-foreground'}`}>
